...
def read_file(file_name, input_stream):
    ...
    output_file = "{}.xml".format(file_name[:-5])  # Create the output xml file 
    ...
    try:
        ...
        print(error)
        exit(1)
    listener = Listener(parser, output_file)   # Create a new listener to parse the jack file into the output file
