...
class Parser:
    ...
    def command_type(self):
        ...
        # if the command starts with "pop" it is type C_POP
            ...
            return "C_POP"
        # if the command starts with "label" it is type C_LABEL
        elif arguments[0] == "label":
            return "C_LABEL"
        # if the command starts with "goto" it is type C_GOTO
        elif arguments[0] == "goto":
            return "C_GOTO"
        # if the command starts with "if-goto" it is type C_IF
        elif arguments[0] == "if-goto":
            return "C_IF"
        # if the command starts with "function" it is type C_FUNCTION
        elif arguments[0] == "function":
            return "C_FUNCTION"
        # if the command starts with "return" it is type C_RETURN
        elif arguments[0] == "return":
            return "C_RETURN"
        # if the command starts with "call" it is type C_CALL
    ...
    def arg1(self):
        ...
        if command_type == "C_PUSH" or command_type == "C_POP": 
            ...
            # Checks if there are no arguments to be returned
                ...
                exit(1)
        # If the command is type C_LABEL, C_GOTO_ C_IF, C_FUNCTION or C_CALL returns the first argument
        elif command_type == "C_LABEL" or command_type == "C_GOTO" or command_type == "C_IF" or command_type == "C_FUNCTION" or command_type == "C_CALL":
            try:
                return arguments[1]
            # Checks if there are no arguments to be returned
            except IndexError:
    ...
    def arg2(self):
        """ Returns the second argument of the current command 
            It is called only when the command is type C_PUSH, C_POP, C_FUNCION or C_CALL """
